...
public class RegistroAutomotorTest {
	...
	public void testVehiculosQueDebenRealizarVtv() {
		...
		VehiculoPolicial vehiculoPolicial = new VehiculoPolicial(LocalDate.of(2018, 1, 1), "Buenos Aires");
		Vehiculo vehiculoReciente = new Vehiculo(LocalDate.of(2018, 1, 1), "BuenosAires");
		Vehiculo vehiculoLaPlata = new Vehiculo(LocalDate.of(2018, 1, 1), "La Plata");
		Vehiculo vechiculoCumpleVtv = new Vehiculo(LocalDate.of(2018, 1, 1), "Buenos Aires");
